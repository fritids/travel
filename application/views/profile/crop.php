...
<div class="four columns">
  ...
  <div id="default-example-info" class="background" data-collapse>
                            ...
                            <?php if(isset($profile_details) && ($profile_details->user_type==1 || $profile_details->user_type==3)) { ?>
                                ...
                                <li class="active"><a href="<?php echo base_url();?><?php echo $this->config->item('user_profile_immagini_edit_url');?>"><?php echo lang('struttura_Immagini');?></a></li>
                            <?php } else { ?>   
							...
							<div class="tabs-container">
									 	<div class="tab-content" id="tab5">	
											<div class="padding">
												<?php echo $this->template->block('CropImmagini','profile/crop_images.php');?>
											</div>
										<div class="clearfix-big"></div>
										</div>
							</div>
