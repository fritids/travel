...
<div class="four columns">
  ...
  <div id="default-example-info" class="background" data-collapse>
                            ...
                            <?php if(isset($profile_details) && ($profile_details->user_type==1 || $profile_details->user_type==3)) { ?>
                                ...
                                <li class="active"><a href="<?php echo base_url();?><?php echo $this->config->item('user_profile_servizi_edit_url');?>"><?php echo lang('struttura_servizi');?></a></li>
							...
							<div class="tabs-container">
									 	<div class="tab-content" id="tab3">	
											<div class="padding">
											<form id="profile_edit_form3" style="width:660px;" name="profile-edit-form" method="post" action="<?php echo base_url();?><?php echo $this->config->item('save_servizi_url');?>">    
												<?php echo $this->template->block('Servizi','profile/hotel_profile_form_parts/Servizi.php');?>
											</form>        
											</div>
										<div class="clearfix-big"></div>
										</div>
