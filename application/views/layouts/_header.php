		...
		<div class="eleven columns">
			<div id="navigation">
				<ul id="nav">				
					...
					<a style="margin-top:5px;margin-left:15px;" href="<?php echo base_url();?><?php echo $this->config->item('how_it_work_page_for_hotel_owner_url'); ?>" class="button small btn-red" style="float:right;">Publish Offers</a> 
        		    <?php if(isset($is_loggedin) && $is_loggedin=="true"){ ?>
					<?php }else{ ?>
        		    <a style="margin-top:5px;margin-left:0px;" href="<?php echo base_url();?><?php echo $this->config->item('signup_url'); ?>" class="button small btn-red" style="float:right;">Sign up</a> 
					<?php } ?>
                </ul>
			</div>
