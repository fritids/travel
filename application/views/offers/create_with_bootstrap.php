...
<div class="clearfix-big"></div>
                    ...
                    <div style="clear:both;">
						...
						<textarea class="input-big" name="offer_package_description_it" id="offer_package_description_it" style="margin:0px; padding:0px; width:600px;"/></textarea>
                    </div>
                    ...
                    <label><?php echo lang('package_description_en');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_en" id="offer_package_description_en" style="margin:0px; padding:0px; width:600px;"/></textarea>
                    	</div>
                    </div>
                    ...
                    <label><?php echo lang('package_description_fr');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_fr" id="offer_package_description_fr" style="margin:0px; padding:0px; width:600px;"/></textarea>
                        </div>
                    </div>
                    ...
                    <label><?php echo lang('package_description_de');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_de" id="offer_package_description_de" style="margin:0px; padding:0px; width:600px;"/></textarea>
                        </div>
                   	</div>
                    ...
                    <label><?php echo lang('package_description_es');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_es" id="offer_package_description_es" style="margin:0px; padding:0px; width:600px;"/></textarea>
                        </div>    
                    </div>
