...
<div class="clearfix-big"></div>
  ...
  <label class="padding_top_7"><?php echo lang('offer_includes');?></label>
                    ...
                    <label><?php echo lang('package_description_it');?></label><br>
						...
						<textarea class="input-big" name="offer_package_description_it" id="offer_package_description_it" style="margin:0px; padding:0px; width:600px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_it;?></textarea>					                    <div class="clearfix-big"></div>
						</div>
                    </div>
                    
                    <div class="clearfix"></div>
                    <div id="div_offer_description_en" <?php if(CURRENT_LANGUAGE=="en") { ?> style="display:block;"<?php }else{ ?> style="display:none;" <?php } ?> >
                    <label><?php echo lang('package_description_en');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_en" id="offer_package_description_en" style="margin:0px; padding:0px; width:600px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_en;?></textarea>					                    <div class="clearfix-big"></div>
						</div>
                    </div>
                    
                    <div class="clearfix"></div>
                    <div id="div_offer_description_fr" <?php if(CURRENT_LANGUAGE=="fr") { ?> style="display:block;"<?php }else{ ?> style="display:none;" <?php } ?> >
                    <label><?php echo lang('package_description_fr');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_fr" id="offer_package_description_fr" style="margin:0px; padding:0px; width:600px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_fr;?></textarea>
							<div class="clearfix-big"></div>
                        </div>    
                    ...
                    <label><?php echo lang('package_description_de');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_de" id="offer_package_description_de" style="margin:0px; padding:0px; width:600px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_de;?></textarea>					                    <div class="clearfix-big"></div>
						</div>
                    </div>
                    
                    <div class="clearfix"></div>
                    <div id="div_offer_description_es" <?php if(CURRENT_LANGUAGE=="es") { ?> style="display:block;"<?php }else{ ?> style="display:none;" <?php } ?> >
                    <label><?php echo lang('package_description_es');?></label><br>
                    	<div style="clear:both;">
							...
							<textarea class="input-big" name="offer_package_description_es" id="offer_package_description_es" style="margin:0px; padding:0px; width:600px;"/><?php if(isset($offer_details)) echo $offer_details->offer_package_description_es;?></textarea>					                    <div class="clearfix-big"></div>
						</div>
                    </div>
                    <div class="clearfix"></div>
...
<script>
	$('#offer_package_description_it').wysihtml5();
	$('#offer_package_description_en').wysihtml5();
	$('#offer_package_description_de').wysihtml5();
</script>