...
<ul class="breadcrumbs first">
	...
	<li class="active"><a href="{$baseurl}manage/user">Manage Offers</a></li>
</ul>
...
<!-- Add new Offer -->
        <p align=center> <a href="{$baseurl}index.php/manage/offers/add_offer">New Offer </a></p> 
...
{/literal}            
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="{$Offerlist|@count}" onClick="toggle(this.value);"/></th>
                        ...
                        <tbody>
							{foreach from=$Offerlist item=Offer name=listofoffers key=ok}
                            <tr class="gradeA">
                                	<td><input type="checkbox" id="checkbox_{$ok}" name="checkbox_{$ok}" value="{$Offer->offer_id}" /></td>
                                    <td>{$Offer->offer_title}</td>
                                    <td>{if $Offer->offer_status eq "1"}Active{else}Inactive{/if}</td>
									<td class="center"><a href="">Edit</a> &nbsp;|&nbsp; <a href="{$baseurl}index.php/manage/offers/delete/{$Offer->offer_id}" onClick="return confirm('Are you sure that you want to delete this offer?');">Delete</a></td>
                            </tr>
                            {/foreach}
                        </tbody>
                    </table>
