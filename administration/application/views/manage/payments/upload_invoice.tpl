            ...
            <div id="table1">
               ...
               <table>
               		<tr>
                        ...
                        <td>
                        	<select name="user_id" id="user_id">
                            	{foreach from=$all_hotels item=hotel name=listofusers key=uk}
                                	<option value="{$hotel->user_id}">{$hotel->hotel_name} ({$hotel->username})</option>
                                {/foreach}
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="hidden" name="invoice_number" id="invoice_number" value="{$invoice_details->invoice_number}">
                            <input type="hidden" name="pk_invoice" id="pk_invoice" value="{$invoice_details->pk_invoice}">
