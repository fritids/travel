...
<div class="grid_16 widget tabs first">
        ...
        <div class="widget_body">  
            ...
            <!-- Add new serivecs -->
        <p align=center> <a href="{$baseurl}index.php/manage/themes/add_theme">Add New Themes </a> </p>     
...
{/literal}            
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="{$themelist|@count}" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Last Minute Theme</th>
                                <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
							{foreach from=$themelist item=theme name=listofthemes key=tk}
                            <tr class="gradeA">
                                	<td><input type="checkbox" id="checkbox_{$tk}" name="checkbox_{$tk}" value="{$theme->lastminutetheme_id}" /></td>
                                    <td>{$theme->theme_name}</td>
                                    <td class="center"><a href="{$baseurl}index.php/manage/themes/edit_themes/{$theme->lastminutetheme_id}">Edit</a> &nbsp;|&nbsp; <a href="{$baseurl}index.php/manage/themes/delete_themes/{$theme->lastminutetheme_id}">Delete</a></td>
                            </tr>
                            {/foreach}
                        </tbody>
                    </table>
