...
<ul class="breadcrumbs first">
    <li><a href="{$baseurl}index.php/dashboard">Home</a></li>
	<li class="active"><a href="{$baseurl}index.php/manage/user">Manage Users</a></li>
</ul>
...
{/literal}            
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="{$userlist|@count}" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Username</th>
                                <th class="align-left">Email</th>
                                <th class="align-left">Display Name</th>
                        ...
                        <tbody>
                            ...
                            <tr class="gradeA">
                                	<td><input type="checkbox" id="checkbox_{$uk}" name="checkbox_{$uk}" value="{$user->user_id}" /></td>
                                    <td>{$user->username}</td>
                                    <td>{$user->email}</td>

                                    <td>{$user->display_name}</td>
                                    <td class="center">{$user->u_created_on|date_format}</td>
                                    <td class="center"><a href="">Block</a> &nbsp;|&nbsp; <a href="">Edit</a> &nbsp;|&nbsp; <a href="{$baseurl}index.php/manage/user/delete/{$user->user_id}" onClick="return confirm('Are you sure that you want to delete that user?');">Delete</a></td>
                            </tr>
                            {/foreach}
                        </tbody>
                    </table>
