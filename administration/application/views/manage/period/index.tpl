...
<ul class="breadcrumbs first">
	...
	<li class="active"><a href="{$baseurl}manage/themes">Manage Offer Period List</a></li>
</ul>
...
<div class="grid_16 widget tabs first">
        ...
        <p align=center> <a href="{$baseurl}index.php/manage/periods/add_offerperiod">New Offer period </a></button> </p>     
...
{/literal}            
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="{$periodlist|@count}" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Periods</th>
                                <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
							{foreach from=$periodlist item=period name=listofperiods key=pk}
                            <tr class="gradeA">
                                <td><input type="checkbox" id="checkbox_{$pk}" name="checkbox_{$pk}" value="{$period->period_id}" /></td>
                                <td>{$period->period_name}</td>
                                <td class="center"><a href="{$baseurl}index.php/manage/periods/edit_offerperiod/{$period->period_id}">Edit</a> &nbsp;|&nbsp; 
                                <a href="{$baseurl}index.php/manage/periods/delete_offerperiod/{$period->period_id}">Delete</a></td>
                            </tr>
                            {/foreach}
                        </tbody>
                    </table>
