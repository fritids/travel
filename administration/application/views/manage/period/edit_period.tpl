...
<div class="grid_16 widget tabs first">
      ...
      <body align=center;>
          <div id="pagetitle" class="clearfix">
            ...
            <form method="post" action={$baseurl}index.php/manage/periods/update_offerperiod>
                <label>
                    Period Name: </label>
                <label> <input type="text" name="period_name" value="{if $data!=NULL}{$data->period_name }{/if}" >
               <label> <input type="hidden"  name="period_id" value="{if $data!=NULL}{$data->period_id}{/if}" >
