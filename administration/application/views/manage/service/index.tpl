...
<ul class="breadcrumbs first">
	...
	<li class="active"><a href="{$baseurl}manage/services">Manage Hotel Services</a></li>
</ul>
...
<div class="grid_16 widget tabs first">
        ...
        <!-- Add new serivecs -->
        <p align=center> <a href="{$baseurl}index.php/manage/services/add_service">Add New Services </a></button> </p>      
...
{/literal}            
            <div id="table1">
                <table class='dataTable'>
                    <thead>
                        <tr>
                            	<th class="align-left"><input type="checkbox" id="select_all" name="select_all" value="{$servicelist|@count}" onClick="toggle(this.value);"/></th>
                                <th class="align-left">Service Name</th>
                                <th>Action</th>
                        </tr> 
                        </thead>
                        <tbody>
							{foreach from=$servicelist item=service name=listofservices key=sk}
                            <tr class="gradeA">

                                	<td><input type="checkbox" id="checkbox_{$sk}" name="checkbox_{$sk}" value="{$service->facility_id}" /></td>

                                    <td>{$service->facility_name}</td>

                                    <td class="center"><a href="{$baseurl}index.php/manage/services/edit_service/{$service->facility_id}">Edit</a> &nbsp;|&nbsp; <a href="{$baseurl}index.php/manage/services/delete_services/{$service->facility_id}">Delete</a></td>
