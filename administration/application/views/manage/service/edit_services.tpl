...
<div class="grid_16 widget tabs first">
      ...
      <body align=center;>
          <div id="pagetitle" class="clearfix">
            ...
            <form method="post" action={$baseurl}index.php/manage/services/update_services>
                <label>
                    Service Name: </label>
               <input type="hidden" name="facility_id" value="{if $data!=NULL}{$data->facility_id}{/if}" >
               <label> <input type="text" name="facility_name" value="{if $data!=NULL}{$data->facility_name}{/if}" >
