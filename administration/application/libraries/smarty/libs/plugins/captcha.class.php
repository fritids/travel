...
*/		
        ...
        $colorG2 = (rand(250,255)+$colorG)/2;
        $colorB2 = (rand(250,255)+$colorB)/2;
        $this->colorBg = imageColorAllocate($this->img, 235, 241, 235);
        /*
        ...
        */
		$this->colorTxt[0] = imageColorAllocate($this->img, ($colorR - 240), ($colorG2 - 240), ($colorB - 240));
        $this->colorTxt[1] = imageColorAllocate($this->img, ($colorR - 240), ($colorG - 240), ($colorB2 - 240));
    ...
    function PutLetters()
    {
        ...
        for($i=0 ; $i < $this->strLength ; $i++)
        {
            ...
            $place = $range*($i+1) + rand(1,$range/3) - rand(1,$range/3);
