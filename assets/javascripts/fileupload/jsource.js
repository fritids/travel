...
$.fn.Uploadrr = function( options ) {
    var settings = {
        ...
        'maxFileSize': -1,
        'maxFileCount': -1,
        'progressGIF': CI.base_url+'assets/stylesheets/fileupload/pr.gif',
        'target': CI.base_url+'profile/do_image_upload',
        //'target': CI.base_url+'upload.php',
        'onComplete': function () {},
        'onError': function () {}
        };
    if ( options ) {
    ...
    var internal = {
        ...
        allDone: function () {
            ...
            window.location= CI.base_url + "profile/crop";
                },
        ...
        uploadModern: function ( file ) {
            ...
            this.xhr.onreadystatechange = $.proxy(function ()  {
                ...
                if (this.reply.success) {
							textHolder = this.settings.showLinks? $('<a/>',{"href":this.reply.file}) : $('<span/>');
							textHolder.html(this.reply.file);
                            $(this.fileListDiv.children('.fileItem')[this.current].children[2]).html(textHolder);
                            this.current++;
